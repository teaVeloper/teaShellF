...
fpath+=( $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-changyuheng-SLASH-fz )
source $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-changyuheng-SLASH-fz/fz.plugin.zsh
fpath+=( $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-changyuheng-SLASH-zsh-interactive-cd )
source $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-changyuheng-SLASH-zsh-interactive-cd/zsh-interactive-cd.plugin.zsh
...
fpath+=( $ZDOTDIR/local_plugins/zleditor )
source $ZDOTDIR/local_plugins/zleditor/zleditor.plugin.zsh
fpath+=( $ZDOTDIR/local_plugins/aliases )
source $ZDOTDIR/local_plugins/aliases/aliases.plugin.zsh
fpath+=( $ZDOTDIR/local_plugins/dirs )
source $ZDOTDIR/local_plugins/dirs/dirs.plugin.zsh
fpath+=( $ZDOTDIR/local_plugins/history )
source $ZDOTDIR/local_plugins/history/history.plugin.zsh
fpath+=( $ZDOTDIR/local_plugins/global_alias )
source $ZDOTDIR/local_plugins/global_alias/global_alias.plugin.zsh
fpath+=( $ZDOTDIR/local_plugins/cursor_mode )
...
fpath+=( $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ohmyzsh-SLASH-ohmyzsh/plugins/jump )
source $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ohmyzsh-SLASH-ohmyzsh/plugins/jump/jump.plugin.zsh
